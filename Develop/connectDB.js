...
const database = mysql.createConnection(
    ...
    host: 'localhost',
    user: 'root',
    password: ' ',                      //Removed password for safety reasons
